  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "0ce69dda-8338-43a9-9c9e-0dbfba0edef1",
          "type": "basic.input",
          "data": {
            "name": "x",
            "range": "[31:0]",
        ...
        {
          "id": "88a6be13-1950-41e3-a0d7-ea86187091e0",
          "type": "basic.output",
          "data": {
            "name": "q",
            "range": "[31:0]",
        ...
        {
          "id": "a3afaae9-973d-487b-89d3-e79e6fbbcc08",
          "type": "basic.input",
          "data": {
            "name": "y",
            "range": "[31:0]",
        ...
        {
          "id": "f44eace4-694c-4892-8fe7-3830f9b98e6c",
          "type": "basic.output",
          "data": {
            "name": "r",
            "range": "[31:0]",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "0ce69dda-8338-43a9-9c9e-0dbfba0edef1",
            "port": "out"
          },
          "target": {
            "block": "396814a2-9764-4311-96f8-10d766e29af3",
        ...
        {
          "source": {
            "block": "a3afaae9-973d-487b-89d3-e79e6fbbcc08",
            "port": "out"
          },
          "target": {
            "block": "396814a2-9764-4311-96f8-10d766e29af3",
        ...
        },
        {
          ...
          "target": {
            "block": "88a6be13-1950-41e3-a0d7-ea86187091e0",
            "port": "in"
          },
          "size": 32
        },
        {
          ...
          "target": {
            "block": "f44eace4-694c-4892-8fe7-3830f9b98e6c",
            "port": "in"
          },
          "size": 32
        }
